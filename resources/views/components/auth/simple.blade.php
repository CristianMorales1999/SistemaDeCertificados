...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-[var(--color-primary-50)] antialiased dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900">
        <div class="bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            <!-- Corregido: eliminado w-1/4 y ajustado responsive con w-full -->
            <div class="flex w-full max-w-sm flex-col gap-2 shadow-xl bg-white p-7 border rounded-xl"><!-- white esta tal cual en el Figma-->
